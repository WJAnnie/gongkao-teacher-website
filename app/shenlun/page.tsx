...
const links = [
  ['01 / METHOD', '方法框架', '五大题型、核心能力、表达规则与实用技巧，先把申论的知识骨架搭起来。五大题型均可进入独立知识页。', '/shenlun/framework/'],
  ['02 / PRACTICE', '真题精练', '从国考到各地申论真题，按年份、地区和题型进入真实材料，题目与答案放在同一条记录里。', '/shenlun/questions/'],
  ['03 / WRITING', '写作积累', '按“热点理解—案例论据—规范用词—语言表达—作文成文”的顺序，建立自己的写作素材系统。', '/shenlun/writing/'],
