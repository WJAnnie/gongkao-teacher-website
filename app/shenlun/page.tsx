...
const links = [
  ['01', '方法框架', '五大题型、核心能力、表达规则与实用技巧，先把申论的知识骨架搭起来。五大题型均可进入独立知识页。', '/shenlun/framework/'],
  ['02', '真题精练', '从国考到各地申论真题，按年份、地区和题型进入真实材料，题目与答案放在同一条记录里。', '/shenlun/questions/'],
  ['03', '写作积累', '按“热点理解—案例论据—规范用词—语言表达—作文成文”的顺序，建立自己的写作素材系统。', '/shenlun/writing/'],
  ['04', '课程现场', '自己的课程精讲、课堂实录、工作日常与碎片分享，保留真实教学过程。', '/shenlun/videos/'],
] as const;

export default function ShenlunPage() {
  return (
    <ShenlunShell tone="home" eyebrow="申论学习地图" title="把申论，学成一套能反复使用的方法。" desc="不是把知识点越堆越多，而是把方法、真题、积累和课堂串成一条可以长期复习的学习路径。">
